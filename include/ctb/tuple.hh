...
struct tuple : ::std::remove_cvref_t<typename decltype(details::get_tuple_impl_<Args...>(
    ...
    constexpr auto& get() & noexcept {
        return static_cast<details::tuple_element_impl_<I, Args...>*>(this)->val_;
    }

    template<::std::size_t I>
    [[nodiscard]]
    constexpr auto const& get() const& noexcept {
        return static_cast<details::tuple_element_impl_<I, Args...> const*>(this)->val_;
    }

    template<::std::size_t I>
    [[nodiscard]]
    constexpr auto& get() && noexcept {
        return ::std::move(static_cast<details::tuple_element_impl_<I, Args...>*>(this)->val_);
    }

    template<::std::size_t I>
    [[nodiscard]]
    constexpr auto const&& get() const&& noexcept {
        return ::std::move(static_cast<details::tuple_element_impl_<I, Args...> const*>(this)->val_);
    }
};
